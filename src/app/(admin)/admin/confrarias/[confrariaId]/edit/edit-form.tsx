...
export function EditConfrariaForm({ confraria }: EditConfrariaFormProps) {
    ...
    useEffect(() => {
        if (selectedDistrict && portugalDistricts[selectedDistrict as keyof typeof portugalDistricts]) {
            ...
            // Don't reset municipality if it's already set and valid for the district
            const currentMunicipality = form.getValues('municipality');
            if (!portugalDistricts[selectedDistrict as keyof typeof portugalDistricts].includes(currentMunicipality)) {
     ...
     useEffect(() => {
        // Pre-populate municipalities on initial load
        if (confraria.district && portugalDistricts[confraria.district as keyof typeof portugalDistricts]) {
            setMunicipalities(portugalDistricts[confraria.district as keyof typeof portugalDistricts]);
        }
    }, [confraria.district]);
