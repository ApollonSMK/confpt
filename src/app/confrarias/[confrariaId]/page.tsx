...
import { ArrowLeft, BookOpen, Check, Clock, MapPin, UserPlus } from 'lucide-react';
...
export default async function ConfrariaPage({ params }: ConfrariaPageProps) {
    ...
    return (
        <div className="container mx-auto px-4 py-8 md:py-12">
            ...
            <section className="bg-card border rounded-lg p-6 md:p-8 mb-12 md:mb-16">
                 <div className="flex flex-col md:flex-row items-center gap-6 md:gap-8">
                    <Image
                        ...
                        width={150}
                        height={150}
                        className="rounded-full bg-muted p-3 shadow-lg -mt-16 md:-ml-16 md:-mt-0"
