...
import { updateConfrariaImages, addCroppedGalleryImage } from './actions';
...
export const ImageCropModal = ({
  ...
  const handleSaveCrop = async () => {
    ...
    try {
      ...
      const result = await updateConfrariaImages(formData);
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
             ...
             <div className="space-y-2">
                ...
                <Textarea id="description" value={description} onChange={(e) => setDescription(e.target.value)} placeholder="Descreva esta imagem..."/>
            </div>
            <div className="flex justify-end gap-2">
              <Button
                variant="ghost"
