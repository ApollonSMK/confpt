...
import { handleMembershipAction, upsertEvent } from './actions';
...
function ClientManagePage({ confrariaData, pendingMembers, events, user }: ManageConfrariaPageProps) {
